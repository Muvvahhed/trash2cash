...
const LandingPage = () => {
	return (
		<div className="size-full">
			...
			<section className="h-dvh w-full text-center bg-green-500 via-green-700  md:bg-gradient-to-b from-green-500 to-slate-900 flex items-center flex-col justify-center text-slate-900 gap-5 ">
